...
$mail = new PHPMailer(true);
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO membertbl (Account_ID, ServiceID, Message) VALUES ($id, $service, '$message');";
        ...
        if($result = mysqli_query($con, $sql)){
            ...
            try {
              ...
              //Recipients
              $mail->setFrom('rfg2376@gmail.com', 'Membership Inquiry');
              $mail->addAddress($email, $fullname);     //Add a recipient             

              $mailbody = '
              <h3>Greetings, ' .$fullname. '!</h3>
                <p>Thank you for inquiring to our gym. </p>
              ...
              $mail->Subject = 'Member Inquiry';
              $mail->Body    = $mailbody;
              $mail->AltBody = strip_tags($mailbody);
          
              $mail->send();

              header('location: memberForm.php?inquirysuccess');
              die();
          } catch (Exception $e) {
