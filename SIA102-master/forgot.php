...
require "include/mail.php";
	...
	function send_email($email){
		...
		//send email here
		send_mail($email,'Password Reset',"Your OTP is " . $code. ", Don't Share your OTP with Anyone");
	}
	...
	function save_password($password){
		...
		$query = "update  account set Password = '$password' where Email_Add  = '$email' limit 1";
		mysqli_query($con,$query);
	...
	function valid_email($email){
		...
		$query = "select * from account where Email_Add = '$email' limit 1";		
				...
				case 'enter_code':
					...
					?>
						<form method="post" action=" forgot.php?mode=enter_code"> 
							...
							<input minlength="6" maxlength="6" class="textbox" type="text" name="code" placeholder="123456" autocomplete="off"><br>
							<br style="clear: both;">
